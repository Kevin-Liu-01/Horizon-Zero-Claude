...
Runtime, `labs/hybrid/posePlayer.js`:
...
- `labs/hybrid/boneMap.js` — bone map, clip list, contact/sync config
- `labs/hybrid/posePlayer.js` — `Pose`, `PosePlayer`,
  `LocomotionBlend`, `conformToFloor`
- `labs/hybrid/main.js` — standalone page (Aloy `skeletonClone` +
