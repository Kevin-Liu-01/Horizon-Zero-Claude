...
| files | 167 |
| sets | 104 |
| total size | 2470.3 KB (budget 40 MB) |
...
| `aloy/effort-2.ogg` | `aloy/effort` | 0.36 s | 2.6 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `aloy/hurt-2.ogg` | `aloy/hurt` | 0.48 s | 3.4 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `amb/campfire.ogg` | `amb/campfire` | 12.96 s | 127.2 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `amb/meadow.ogg` | `amb/meadow` | 12.96 s | 127.2 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `amb/river.ogg` | `amb/river` | 12.96 s | 127.2 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `bow/hunter/draw.ogg` | `bow/hunter/draw` | 0.90 s | 6.3 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `bow/war/release-2.ogg` | `bow/war/release` | 0.60 s | 4.2 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `foot/dirt-3.ogg` | `foot/dirt` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `foot/grass-1.ogg` | `foot/grass` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `foot/rock-1.ogg` | `foot/rock` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `foot/silt-2.ogg` | `foot/silt` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `idle/sawtooth.ogg` | `idle/sawtooth` | 3.18 s | 21.9 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `idle/scrapper.ogg` | `idle/scrapper` | 3.18 s | 21.9 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `idle/strider.ogg` | `idle/strider` | 3.18 s | 21.9 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `idle/thunderjaw.ogg` | `idle/thunderjaw` | 3.18 s | 21.9 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `machine/scan-ping.ogg` | `machine/scan-ping` | 0.84 s | 4.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `melee/crit-1.ogg` | `melee/crit` | 0.78 s | 5.5 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/crit-2.ogg` | `melee/crit` | 0.78 s | 5.5 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/heavy-1.ogg` | `melee/heavy` | 0.72 s | 5.1 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/heavy-2.ogg` | `melee/heavy` | 0.72 s | 5.1 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/light-1.ogg` | `melee/light` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/light-2.ogg` | `melee/light` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/light-3.ogg` | `melee/light` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/silent.ogg` | `melee/silent` | 0.90 s | 6.3 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/whoosh-1.ogg` | `melee/whoosh` | 0.36 s | 2.6 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/whoosh-2.ogg` | `melee/whoosh` | 0.36 s | 2.6 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `melee/whoosh-3.ogg` | `melee/whoosh` | 0.36 s | 2.6 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `mstep/light-1.ogg` | `mstep/light` | 0.36 s | 2.6 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `mstep/medium-2.ogg` | `mstep/medium` | 0.48 s | 3.4 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `mstep/medium-3.ogg` | `mstep/medium` | 0.48 s | 3.4 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `music/sting-discover.ogg` | `music/sting-discover` | 2.58 s | 19.6 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `rope/attach-1.ogg` | `rope/attach` | 0.54 s | 3.8 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `rope/attach-2.ogg` | `rope/attach` | 0.54 s | 3.8 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `rope/tie.ogg` | `rope/tie` | 0.78 s | 5.2 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `status/shock.ogg` | `status/shock` | 2.40 s | 16.6 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `trap/place-1.ogg` | `trap/place` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `trap/place-2.ogg` | `trap/place` | 0.42 s | 3.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `trap/trigger-1.ogg` | `trap/trigger` | 0.60 s | 4.2 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `trap/trigger-2.ogg` | `trap/trigger` | 0.60 s | 4.2 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `voice/longleg/strike.ogg` | `voice/longleg/strike` | 0.90 s | 4.4 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `voice/strider/strike.ogg` | `voice/strider/strike` | 0.90 s | 5.1 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
| `voice/strider/windup.ogg` | `voice/strider/windup` | 0.90 s | 6.0 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
...
| `voice/thunderjaw/windup.ogg` | `voice/thunderjaw/windup` | 1.14 s | 7.8 KB | CC0-1.0 | Horizon Zero Claude (procedurally synthesized, no third-party audio) | https://github.com/Kevin-Liu-01/Horizon-Zero-Claude — synthesized by tools/audio-recipes.js |
